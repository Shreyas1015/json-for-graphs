...
//     setFormData((prevData) => {
//       const newData = { ...prevData };
//       newData.data.metrics[index].labels.push("");
//       return newData;
//     });
//   };
...
//                 label="Metric Name"
//                 value={metric.name}
//                 onChange={(e) => handleInputChange(e, "metrics", "name", index)}
//                 fullWidth
//               />
//             </Grid>
//             <Grid item xs={12} sm={3}>
...
//                 label="Type"
//                 value={metric.type}
//                 onChange={(e) => handleInputChange(e, "metrics", "type", index)}
//                 fullWidth
//               />
//             </Grid>
//             <Grid item xs={12} sm={3}>
...
//             {/* Conditional Label Field for Pie Chart */}
//             {formData.info.type === "pie" && (
//               <>
//                 {metric.labels.map((label, labelIndex) => (
//                   <Grid item xs={12} sm={4} key={labelIndex}>
//                     <TextField
...
//         <Grid item xs={12}>
//           <Button onClick={handleAddAxis} variant="outlined" color="secondary">
//             Add Axis
//           </Button>
//         </Grid>
//       </Grid>
